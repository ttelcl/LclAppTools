/*
 * (c) 2021
 * Inspired by https://gist.github.com/LGM-AdrianHum/260bc9ab3c4cd49bc8617a2abe84ca74 
 */
...
{
  // Original version: https://gist.github.com/LGM-AdrianHum/260bc9ab3c4cd49bc8617a2abe84ca74

  /// <summary>
  /// Provides access to NTFS junction points
  /// </summary>
      ...
      using(var handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
      {
        ...
        try
        {
          ...
          var result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_SET_REPARSE_POINT,
              inBuffer, targetDirBytes.Length + 20, IntPtr.Zero, 0, out var bytesReturned, IntPtr.Zero);
